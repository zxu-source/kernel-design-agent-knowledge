 ...
 * Description: ShmemMoeDistributeCombineV2 tiling function implementation file
 * History: 2025-12-16 create ShmemCommMoeDistributeCombineV2 tiling function implementation file
 */
#include <queue>
#include <vector>
#include <dlfcn.h>
...
#include "../op_kernel/shmem_moe_distribute_combine_v2_tiling.h"
...
const char *K_INNER_DEBUG = "ShmemMoeDistributeCombineV2 Tiling Debug";
...
// a3专有
static void PrintTilingDataInfo(const char *nodeName, ShmemMoeDistributeCombineV2TilingData &tilingData)
{
...
static ge::graphStatus GetAttrAndSetTilingData(const gert::TilingContext *context,
                                               ShmemMoeDistributeCombineV2TilingData &tilingData, const char *nodeName,
...
static bool CheckTensorShape(const gert::TilingContext *context, ShmemMoeDistributeCombineV2TilingData &tilingData,
...
static bool CheckSharedAttrs(const char *nodeName, const ShmemMoeDistributeCombineV2TilingData &tilingData)
{
    uint32_t sharedExpertNum = tilingData.moeDistributeCombineV2Info.sharedExpertNum;
    uint32_t sharedExpertRankNum = tilingData.moeDistributeCombineV2Info.sharedExpertRankNum;
...
static bool CheckAttrs(const gert::TilingContext *context, ShmemMoeDistributeCombineV2TilingData &tilingData,
...
static void SetHCommCfg(const gert::TilingContext *context, ShmemMoeDistributeCombineV2TilingData *tiling,
...
static ge::graphStatus MoeDistributeCombineA3TilingFuncImpl(gert::TilingContext *context)
{
    ...
    ShmemMoeDistributeCombineV2TilingData *tilingData = context->GetTilingData<ShmemMoeDistributeCombineV2TilingData>();
...
static ge::graphStatus ShmemMoeDistributeCombineV2TilingFunc(gert::TilingContext *context)
{
...
ge::graphStatus TilingParseForShmemMoeDistributeCombineV2(gert::TilingParseContext *context)
{
    (void)context;
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_OPTILING(ShmemMoeDistributeCombineV2)
    .Tiling(ShmemMoeDistributeCombineV2TilingFunc)
    .TilingParse<MoeDistributeCombineCompileInfo>(TilingParseForShmemMoeDistributeCombineV2);
}  // namespace optiling
